const locale = {
  enUS: {
    ...
    config: {
      ...
      toggleOption8: 'DH, CRIT, DCRIT, Deaths',
  ...
  ptBR: {
    ...
    config: {
      ...
      toggleOption8: 'DH, CRIT, DCRIT, Mortes',
      toggleOption9: 'Discord',
      toggleOption10: 'Língua',
      toggleOption11: 'Max Hit',
      toggleOption12: 'Mostrar Combatentes Sem Classe',
      toggleOption13: 'Destaque Você',
      toggleOption14: 'Combine Pets',
