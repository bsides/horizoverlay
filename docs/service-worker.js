...
var precacheConfig = [
    ['/horizoverlay/index.html', '192afeda6a6adede32e51e8507224532'],
    [
      '/horizoverlay/static/css/main.38c52ef9.css',
      '370acc5e443d04b25eef5d932d07a87d'
    ],
    [
      '/horizoverlay/static/js/main.13b921c8.js',
      '2ca570397c760daaef026b459cec47eb'
    ],
    [
      '/horizoverlay/static/media/mog.e1e18820.png',
      'e1e188201661cad8e440f57279b85a23'
    ]
  ],
  cacheName =
  ...
  self.addEventListener('fetch', function(e) {
    if ('GET' === e.request.method) {
      ...
      !t &&
        ...
        ((n = new URL('/horizoverlay/index.html', self.location).toString()),
        (t = urlsToCacheKeys.has(n))),
        t &&
          e.respondWith(
            caches
